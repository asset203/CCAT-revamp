...
@Component({
    ...
    styleUrls: ['./contract-balance.component.scss'],
})
export class ContractBalanceComponent implements OnInit, OnDestroy {
    reportData;
    reportsHeaders;
    ...
    dateTime = new Date();
    getContractBalanceReportPermission: boolean;
    classNameCon = '';
    isopened: boolean;
    isopenedNav: boolean;
    ...
    setPermissions() {
        let viewReportPermission: Map<number, string> = new Map().set(253, 'contractBalance');
        this.featuresService.checkUserPermissions(viewReportPermission);
        this.getContractBalanceReportPermission = this.featuresService.getPermissionValue(253);
    }
