...
import { NbaGiftsSliderComponent } from './components/nba-gifts-slider/nba-gifts-slider.component';
...
@NgModule({
    ...
    exports: [
        ...
        ThreeDotsPipe,
        NgSelectModule,
        SubmitOnEnterDirective, NbaGiftsSliderComponent
    ],
})
