...
public class MessagesCache {
    ...
    public String getExternalSystemErrorMsg(Integer code) {

        if (MESSAGES_MAP != null && MESSAGES_MAP.get("ext") != null
                && MESSAGES_MAP.get("ext").get(code) != null) {
            return MESSAGES_MAP.get("ext").get(code);
        }
        return "";
    }

    public String getVoucherErrorMsg(Integer code) {

        if (MESSAGES_MAP != null && MESSAGES_MAP.get("voucher") != null
                && MESSAGES_MAP.get("voucher").get(code) != null) {
            return MESSAGES_MAP.get("voucher").get(code);
        }
        return "";
    }
