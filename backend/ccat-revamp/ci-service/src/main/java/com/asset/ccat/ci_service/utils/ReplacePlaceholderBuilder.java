package com.asset.ccat.ci_service.utils;
 ...
 */
public class ReplacePlaceholderBuilder {
     ...
     */
    public ReplacePlaceholderBuilder addPlaceholder(String placeholder, String value) {
     ...
     * @return The current UrlPlaceholderBuilder object (for chaining).
     */
    public ReplacePlaceholderBuilder addOptionalPlaceholder(String placeholder, String value) {
