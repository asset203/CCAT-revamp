...
public class Encryptor {
    ...
    public static String decrypt(String encryptedText) {
        try {
            ...
            CCATLogger.DEBUG_LOGGER.error("Exception occurred while decrypting text. ", e);
            CCATLogger.ERROR_LOGGER.error("Exception occurred while decrypting text. ", e);
            return encryptedText; // tolerance while login.
        }
    }
