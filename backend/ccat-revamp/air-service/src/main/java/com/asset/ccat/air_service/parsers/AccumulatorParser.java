 ...
 */
@Service
public class AccumulatorParser implements Parser{
    ...
    @Override
    public void parse(Node currentNode, Map<String, Object> responseStrArr) {
        CCATLogger.DEBUG_LOGGER.debug("Start parsing Accumulators response");
