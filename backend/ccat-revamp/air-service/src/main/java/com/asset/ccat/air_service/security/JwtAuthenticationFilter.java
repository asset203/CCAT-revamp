 ...
 */
package com.asset.ccat.air_service.security;

import com.asset.ccat.air_service.tasks.ScheduledTask;
...
import com.asset.ccat.air_service.models.security.HttpRequestWrapper;
import com.asset.ccat.air_service.models.users.UserModel;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected HttpRequestWrapper doAuthenticationFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException, AIRServiceException {
        ...
        if (authToken != null) {
            ...
            throw new AIRServiceException(ErrorCodes.ERROR.NOT_AUTHORIZED);
        }
