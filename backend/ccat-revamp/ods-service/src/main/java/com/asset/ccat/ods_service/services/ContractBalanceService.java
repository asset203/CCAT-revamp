...
@Service
public class ContractBalanceService implements DSSReportService<DSSResponseModel, DSSReportRequest> {
    private final ReportsDao reportsDao;
    private final DSSCache dssCache;
    private final DssReportMapper mapper;
    private final DateUtils dateUtil;

    public ContractBalanceService(ReportsDao reportsDao, DSSCache dssCache, DssReportMapper mapper, DateUtils dateUtil) {
    ...
    public DSSResponseModel getReport(DSSReportRequest request) throws ODSException, SQLException {
        String spName = getSPName(DSSReports.CONTRACT_BALANCE.getPageName(), dssCache);
