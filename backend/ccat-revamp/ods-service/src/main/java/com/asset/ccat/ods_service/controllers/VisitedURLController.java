...
import com.asset.ccat.ods_service.services.VisitedURLService;
...
public class VisitedURLController {
    ...
    @PostMapping(value = Defines.ContextPaths.VISITED_URL + Defines.WEB_ACTIONS.GET_ALL)
    public BaseResponse<DSSResponseModel> getVisitedURLReport(@RequestBody DSSReportRequest request) throws ODSException, SQLException, ODSException, SQLException {
        ThreadContext.put("sessionId", request.getSessionId());
        ThreadContext.put("requestId", request.getRequestId());
        DSSResponseModel resposne = visitedURLService.getReport(request);
