 ...
 */
public class ReplacePlaceholdersUtil {
     ...
     */
    public ReplacePlaceholdersUtil addPlaceholder(String placeholder, String value) {
     ...
     * @return The current UrlPlaceholderBuilder object (for chaining).
     */
    public ReplacePlaceholdersUtil addOptionalPlaceholder(String placeholder, String value) {
