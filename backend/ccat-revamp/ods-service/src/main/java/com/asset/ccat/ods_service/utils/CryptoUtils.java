...
public class CryptoUtils {
    ...
    public String encrypt(String Data, String secret) throws ODSException {
        try {
            ...
            throw new ODSException(ErrorCodes.ERROR.ENCRYPTION_FAILED, Defines.SEVERITY.ERROR);
        }
    }

    public String decrypt(String strToDecrypt, String secret) throws ODSException {
        try {
            Key key = generateKey(secret);
            ...
            throw new ODSException(ErrorCodes.ERROR.DECRYPTION_FAILED, Defines.SEVERITY.ERROR);
        }
    }
