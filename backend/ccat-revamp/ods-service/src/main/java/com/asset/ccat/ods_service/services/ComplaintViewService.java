...
@Service
public class ComplaintViewService implements DSSReportService<DSSResponseModel, DSSReportRequest> {
    private final ReportsDao reportsDao;
    private final DSSCache dssCache;
    private final DssReportMapper mapper;
    private final DateUtils dateUtil;

    public ComplaintViewService(ReportsDao reportsDao, DSSCache dssCache, DssReportMapper mapper, DateUtils dateUtil) {
    ...
    public DSSResponseModel getReport(DSSReportRequest request) throws ODSException, SQLException {
        String spName = getSPName(DSSReports.COMPLAINT_VIEW.getPageName(), dssCache);
