...
@Service
public class TrafficBehaviourService implements DSSReportService<DSSResponseModel, DSSReportRequest> {
    private final ReportsDao reportsDao;
    private final DSSCache dssCache;
    private final DssReportMapper mapper;
    private final DateUtils dateUtil;

    public TrafficBehaviourService(ReportsDao reportsDao, DSSCache dssCache, DssReportMapper mapper, DateUtils dateUtil) {
    ...
    public Map<String, Object> setInParamNameValueMap(DSSReportRequest request) {
        ...
        paramNameValueMap.put(SPParams.FLAG.getParamName(), 2);
