...
public class BTIVRController {
    ...
    public BaseResponse<DSSResponseModel> getBTIVRReport(@RequestBody DSSReportRequest request) throws ODSException {
        ThreadContext.put("sessionId", request.getSessionId());
        ThreadContext.put("requestId", request.getRequestId());
        DSSResponseModel resposne = bTIVRService.getBTIVRReport(request);
