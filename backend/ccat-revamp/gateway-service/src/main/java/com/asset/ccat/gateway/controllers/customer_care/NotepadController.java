...
public class NotepadController {
    ...
    public BaseResponse<GetAllNotePadResponse> getAllNotePad(HttpServletRequest req,
        ...
        GetAllNotePadResponse getAllNotePadsResponse = notePadService.getAllNotePad(request);
    ...
    public BaseResponse createNotePad(HttpServletRequest req,
                                      @RequestBody CreateNotePadRequest request) throws GatewayException {
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(request.getToken());
        String sessionId = tokendata.get(Defines.SecurityKeywords.SESSION_ID).toString();
        String username = tokendata.get(Defines.SecurityKeywords.USERNAME).toString();
    ...
    public BaseResponse deleteNotePad(HttpServletRequest req,
                                      @RequestBody DeleteNotePadRequest request) throws GatewayException {
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(request.getToken());
        String sessionId = tokendata.get(Defines.SecurityKeywords.SESSION_ID).toString();
        String username = tokendata.get(Defines.SecurityKeywords.USERNAME).toString();
