...
public class BalanceDisputeDetailsModel implements Serializable {

    private static final long serialVersionUID = -2856219754187210054L;
    ...
    public void setTransactionDetailsList(ArrayList<HashMap<String, String>> transactionDetailsList) {
