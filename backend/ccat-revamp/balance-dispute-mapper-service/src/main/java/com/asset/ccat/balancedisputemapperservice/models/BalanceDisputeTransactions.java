...
public class BalanceDisputeTransactions implements Serializable {

  private ArrayList<HashMap<String,String>> transactionDetails = new ArrayList<>();
  ...
  public ArrayList<HashMap<String,String>> getTransactionDetails() {
    return transactionDetails;
  }

  public void setTransactionDetails(
          ArrayList<HashMap<String,String>> transactionDetails) {
