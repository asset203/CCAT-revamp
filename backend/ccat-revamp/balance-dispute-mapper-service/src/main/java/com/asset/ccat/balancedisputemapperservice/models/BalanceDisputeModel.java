...
public class BalanceDisputeModel implements Serializable {
  ...
  private ArrayList<BdMocPre> mocPre = new ArrayList<BdMocPre>();

  private BalanceDisputeTransactions bdTransactions = new BalanceDisputeTransactions();

  public BalanceDisputeTransactions getBdTransactions() {
    return bdTransactions;
  }

  public void setBdTransactions(BalanceDisputeTransactions bdTransactions) {
