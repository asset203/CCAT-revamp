...
import com.asset.ccat.nba_service.cache.MessagesCache;
...
import com.asset.ccat.nba_service.models.security.HttpRequestWrapper;
import com.asset.ccat.nba_service.models.users.UserModel;
import com.asset.ccat.nba_service.tasks.ScheduledTask;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected HttpRequestWrapper doAuthenticationFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException, NBAException {
        ...
        if (authToken != null) {
            ...
            throw new NBAException(ErrorCodes.ERROR.NOT_AUTHORIZED);
        }
