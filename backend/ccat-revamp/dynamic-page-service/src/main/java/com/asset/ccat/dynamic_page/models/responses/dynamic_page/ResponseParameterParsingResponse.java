...
public class ResponseParameterParsingResponse {
    private List<HttpParameterModel> parameters;
    private List<String> paths;

    public ResponseParameterParsingResponse() {
    }

    public ResponseParameterParsingResponse(List<HttpParameterModel> parameters, List<String> paths) {
