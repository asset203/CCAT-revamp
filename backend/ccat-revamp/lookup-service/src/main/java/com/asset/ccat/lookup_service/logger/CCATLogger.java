 ...
 */
package com.asset.ccat.lookup_service.logger;
...
//    private static final Logger INFO_LOGGER = LogManager.getLogger("infoLogger");
    ...
    public static final Logger JSON_LOGGER = LogManager.getLogger("CONSOLE_JSON_APPENDER");
    public static final Logger CACHE_STATISTICS_LOGGER = LogManager.getLogger("cacheStatisticsLogger");
