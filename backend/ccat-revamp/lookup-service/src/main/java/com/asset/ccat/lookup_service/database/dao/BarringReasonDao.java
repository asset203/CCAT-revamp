...
public class BarringReasonDao {
    ...
    public String retrieveReason(String msisdn, Integer barringType) throws LookupException {
        ...
        try {
            ...
            return jdbcTemplate.queryForObject(retrieveReasonQuery, String.class, msisdn);

        } catch (EmptyResultDataAccessException ex) {
            CCATLogger.DEBUG_LOGGER.debug("No Barring Reasons Found");
            return null;
        } catch (Exception e) {
            CCATLogger.DEBUG_LOGGER.error("EXCEPTION occurred while retrieve barring. --> ", e);
            CCATLogger.ERROR_LOGGER.error("EXCEPTION occurred while retrieve barring. --> ", e);
    ...
    public void deleteReason(String msisdn, Integer barringType) throws LookupException {
